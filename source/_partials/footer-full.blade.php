    <footer>
        <div class="flex flex-col bg-black text-white p-4 md:flex-row">
            ...
            <div class="flex flex-col w-full pb-4 md:flex-1 md:pr-4">
        ...
        <div class="flex flex-col bg-grey-dark py-4 text-grey-lighter px-4 text-center justify-between font-light md:flex-row">
            <div class="text-sm mb-4 lg:ml-8 md:mb-0 md:text-base">Copyright All Rights Reserved &copy; 2018</div>
            <div class="text-xs text-grey-light lg:mr-8 md:text-base md:text-grey-lighter">Powered by <a class="no-underline text-grey-light hover:text-black md:text-base md:text-grey-lighter" href="https://nobleintegrationsllc.com">Noble Integrations LLC</a></div>
        </div>
    </footer>
